...
CREATE TABLE IF NOT EXISTS users (
  ...
  -- Platform-wide admin flag — distinct from `role` above, which only
  -- describes standing WITHIN a tenant's own account (e.g. a team
  -- member they invited). This flag identifies the platform OWNER
  -- (you) with access to the cross-tenant Client List. Never settable
  -- through the public API — only via a direct SQL UPDATE, see

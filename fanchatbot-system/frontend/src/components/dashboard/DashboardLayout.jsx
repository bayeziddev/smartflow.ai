...
import { LayoutDashboard, KeyRound, Radio, Receipt, LogOut } from 'lucide-react';
    ...
    <div className="flex min-h-screen">
      <aside className="hidden w-60 shrink-0 flex-col border-r border-void-border bg-void-surface/50 sm:flex">
        <div className="flex h-16 items-center gap-2 border-b border-void-border px-6">
          <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-void-elevated text-signal">
            <Radio className="h-3.5 w-3.5" strokeWidth={2} />
          </span>
          <span className="font-display text-sm font-semibold text-ink">Fanchatbot</span>
        </div>
